<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/carousel*') ? 'active' : '' }}" href="{{ route('carousel.index') }}">
                    <i class="fa-solid fa-image"></i> 輪播圖管理
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/dessert*') ? 'active' : '' }}" href="{{ route('dessert.index') }}">
                    <i class="fa-solid fa-cake-candles"></i> 今日甜點管理
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/menu*') ? 'active' : '' }}" href="{{ route('menu.index') }}">
                    <i class="fa-solid fa-bars"></i> 菜單管理
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/highlight*') ? 'active' : '' }}" href="{{ route('highlight.index') }}">
