    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                {{-- 上移/下移 --}}
                <a href=" {{ route('admin.carousel.swap', ['id'=> $carousel->id, 'direction' => 'up']) }}" class="btn btn-sm btn-secondary">上移</a>
                <a href=" {{ route('admin.carousel.swap', ['id'=> $carousel->id, 'direction' => 'down']) }}" class="btn btn-sm btn-secondary">下移</a>
