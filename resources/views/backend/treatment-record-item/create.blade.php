...
<form id="treatment-record-item-create-form"
      action="{{ route('backend.treatment-record-item.store', $record->id) }}"
      method="POST"
    ...
    <div class="mb-3">
        ...
        <select id="treatment-select" name="treatment_id" class="form-select" required disabled>
            <option value="">— 請先選擇療程種類 —</option>
        </select>
    </div>
