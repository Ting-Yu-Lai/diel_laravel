...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h1 class="h2">新增療程紀錄</h1>
    <a href="{{ route('backend.treatment-record.index') }}" class="btn btn-secondary">返回</a>
</div>
...
<form id="treatment-record-create-form"
      action="{{ route('backend.treatment-record.store') }}"
      method="POST"
    ...
    <a href="{{ route('backend.treatment-record.index') }}" class="btn btn-secondary ms-2">取消</a>
</form>
...
(function () {
    ...
    const createForm          = document.getElementById('treatment-record-create-form');
